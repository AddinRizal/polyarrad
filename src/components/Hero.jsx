      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              PT. Poly Arrad Pusaka menyediakan bahan kimia berkualitas tinggi untuk 
              sistem air dan pengolahan limbah dengan teknologi terdepan dan layanan 
              profesional untuk berbagai industri di Indonesia.
            </motion.p>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-6 bg-white/20 backdrop-blur-md rounded-xl p-4 glass-effect"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 bg-white/20 backdrop-blur-md rounded-xl p-4 glass-effect"
            >
              <div className="flex items-center space-x-3">
